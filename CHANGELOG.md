...
- `BRIDGE_COMMAND` / `BRIDGE_CLAUDE_ARGS` / `BRIDGE_CODEX_ARGS` are parsed with a
  quote-aware limited argv parser instead of naive whitespace splitting. Plain
  whitespace-separated values behave identically; quoted values now survive intact.
